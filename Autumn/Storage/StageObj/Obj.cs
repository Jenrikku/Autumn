...
namespace AutumnStageEditor.Storage.StageObj {
    internal class Obj : IArgsObj, IIdentifiableObj, ISwitchableObj, ICameraObj, IClippableObj {
        ...
        public Obj() => Array.Fill(Args, -1);

        //public void TryParseProperties(Dictionary<string, object?> properties) {


        //    // WIP: Implement others.

        //    // WIP: Do parent-children links somewhere else.
        //}
    }
}
