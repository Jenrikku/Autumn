...
// Modified version from: https://github.com/shibbo/Fushigi/blob/main/Fushigi/windowing/ImGuiController.cs
    ...
    private void SetPerFrameImGuiData(float deltaSeconds)
    {
        ...
        if (_windowWidth > 0 && _windowHeight > 0)
        {
            io.DisplayFramebufferScale = new Vector2(
                _window.FramebufferSize.X / _windowWidth,
